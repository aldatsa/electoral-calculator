...
import logging
logger = logging.getLogger('electoralcalculator_lib')

from . helpers import get_builder, show_uri, get_help_uri

# This class is meant to be subclassed by ElectoralcalculatorWindow.  It provides
...
class Window(Gtk.Window):
    ...
    def __new__(cls):
        ...
        Returns a fully instantiated BaseElectoralcalculatorWindow object.
        """
        builder = get_builder('ElectoralcalculatorWindow')
        new_object = builder.get_object("electoralcalculator_window")
    ...
    def finish_initializing(self, builder):
        ...
        and creating a ElectoralcalculatorWindow object with it in order to finish
        initializing the start of the new ElectoralcalculatorWindow instance.
        """
        ...
        self.settings = Gio.Settings("net.launchpad.electoralcalculator")
        ...
        try:
            ...
            LaunchpadIntegration.set_sourcepackagename('electoralcalculator')
        except ImportError:
            pass
        ...
        try:
            from electoralcalculator import indicator
    ...
    def on_mnu_preferences_activate(self, widget, data=None):
        """Display the preferences window for electoralcalculator."""
    ...
    def on_mnu_close_activate(self, widget, data=None):
        """Signal handler for closing the ElectoralcalculatorWindow."""
        self.destroy()

    def on_destroy(self, widget, data=None):
        """Called when the ElectoralcalculatorWindow is closed."""
